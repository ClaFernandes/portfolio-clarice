...
// Navbar fixa no topo com links de navegação e toggle de idioma
// Props:
//   lang    — idioma atual ('pt' ou 'en')
//   setLang — função para alterar o idioma
...
function Navbar({ lang, setLang }) {
  ...
  // Links de navegação — o "to" tem de corresponder ao id da secção
  const links = [
