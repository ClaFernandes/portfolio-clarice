...
//
// Cada projecto tem:
//   name       — nome exibido no card e modal
//   tag        — stack principal (badge colorido)
//   descPt     — descrição em português (modal)
//   descEn     — descrição em inglês (modal)
//   shortPt    — descrição curta para o card em PT
//   shortEn    — descrição curta para o card em EN
//   stack      — tecnologias separadas por " · " (pills no modal)
//   images     — array de paths das screenshots
//               → ficheiros vão em public/assets/
//               → substitui os strings vazios '' pelas imagens reais
//   link       — URL do deploy (null se não existir)
//   github     — URL do repositório (null se não existir)
//   bg         — gradiente de fundo quando não há imagem
//   team       — true se foi projecto em equipa (mostra badge)
//   teamInfo   — informação sobre o colega de equipa (PT/EN)
...
const projects = [
  ...
  // ── 1. AGENDLY ────────────────────────────────────────
  {
    ...
    shortPt: 'Plataforma de agendamentos online para negócios locais. CRM, agenda e painel financeiro num único produto.',
    shortEn: 'Online booking platform for local businesses. CRM, calendar and financial dashboard in one product.',

    // Descrição completa — aparece no modal
    descPt: 'Plataforma de agendamentos online para prestadores de serviços (barbearias, clínicas, personal trainers, etc.). O cliente agenda através de um link público sem criar conta. O prestador gere tudo num dashboard completo: agenda interativa, CRM de clientes com histórico e valor gasto, painel financeiro com gráficos e exportação CSV, gestão de serviços e horários por turnos. Inclui ainda painel de administração com gestão global da plataforma.',
    descEn: 'Online booking platform for service providers (barbershops, clinics, personal trainers, etc.). Clients book through a public link without creating an account. Providers manage everything in a full dashboard: interactive calendar, client CRM with history and spending, financial panel with charts and CSV export, service and shift schedule management. Also includes an admin panel for global platform management.',

    stack: 'React · Supabase · React Router · Recharts · react-big-calendar · CSS Modular',

    // Screenshots — coloca os ficheiros em public/assets/ com estes nomes
    // Sugestão de ordem: landing → dashboard → agenda → financeiro
    images: [
      '/assets/agendly-dashboard.jpg',   // Dashboard do prestador com métricas — mais impactante como primeira imagem
      '/assets/agendly-landing.jpg',     // Landing page do produto
      '/assets/agendly-publica.jpg',     // Fluxo público de agendamento (vista do cliente)
      '/assets/agendly-agenda.jpg',      // Agenda/calendário interactivo
      '/assets/agendly-financeiro.jpg',  // Painel financeiro com gráficos
      '/assets/agendly-admin.jpg',       // Painel de administração global
    ],
  ...
  // ── 2. PÁGINA & CIA ───────────────────────────────────
  {
    ...
    stack: 'React · Context API · React Router · React Hook Form · localStorage · CSS',

    images: [
      '/assets/paginacia-catalogo.jpg',   // Catálogo com grelha de livros (pagina1.jpg)
      '/assets/paginacia-livro.jpg',      // Página individual do livro (pagina2.jpg)
      '/assets/paginacia-carrinho.jpg',   // Carrinho aberto em sidebar (pagina6.jpg)
      '/assets/paginacia-checkout.jpg',   // Checkout — confirmar encomenda (pagina7.jpg)
    ],
  ...
  // ── 3. FOCUS. ─────────────────────────────────────────
  {
    ...
    stack: 'React · Tailwind CSS · Firebase Auth · Firestore · React Router · Lucide React',

    images: [
      '/assets/focus-dashboard.jpg', // Dashboard com lista de tarefas — mostra o produto
      '/assets/focus-login.jpg',     // Ecrã de login com Google Auth
      '/assets/focus-detalhe.jpg',   // Edição de tarefa em modo activo
    ],
  ...
  // ── 4. FLAT FINDER ────────────────────────────────────
  {
    ...
    images: [
      '/assets/flatfinder-imoveis.jpg',   // Lista de imóveis com filtros — mostra o produto
      '/assets/flatfinder-login.jpg',     // Login split-screen
      '/assets/flatfinder-novo.jpg',      // Formulário de novo imóvel
      '/assets/flatfinder-favoritos.jpg', // Página de favoritos
    ],
