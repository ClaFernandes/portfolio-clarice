...
import { FiLinkedin, FiGithub, FiSend, FiCheckCircle, FiAlertCircle } from 'react-icons/fi'
...
// ─── CONTACTO ─────────────────────────────────────────
// Secção com cards de contacto + formulário EmailJS
// Props:
        ...
        <div className="contact__grid">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="contact__form" noValidate>
            ...
            <div className="contact__field">
              <label className="contact__label" htmlFor="from_name">{t.labelName}</label>
              <input
                id="from_name"
                name="from_name"
                type="text"
            ...
            <div className="contact__field">
              <label className="contact__label" htmlFor="from_email">{t.labelEmail}</label>
              <input
                id="from_email"
                name="from_email"
                type="email"
            ...
            <div className="contact__field">
              <label className="contact__label" htmlFor="message">{t.labelMsg}</label>
              <textarea
                id="message"
                name="message"
